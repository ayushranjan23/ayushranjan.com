...
[Giscus](https://giscus.app) leverages Github discussions to act as a comments system. To get Giscus working on your own website, see [here](/research/01-getting-started#deploy-the-site).
...
- Add pagination to the bottom of research posts
- Create 404 page
...
- Fixed: [Giscus does not appear when switching research pages via post navigation](https://github.com/trevortylerlee/astro-micro/issues/32)
